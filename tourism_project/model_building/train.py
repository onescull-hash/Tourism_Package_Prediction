...
numeric_features = ["Age", "DurationOfPitch", "NumberOfPersonVisiting", "CityTier",
    "NumberOfFollowups", "PreferredPropertyStar",
    "NumberOfTrips", "Passport", "PitchSatisfactionScore",
    "OwnCar", "NumberOfChildrenVisiting", "MonthlyIncome"]   # complete the code to list all numerical feature names (same as in prep.py)

categorical_features = ["TypeofContact", "ProductPitched",
...
# Reduced values for quicker experimentation, but can be expanded for more thorough tuning
param_grid = {
    'xgbclassifier__n_estimators': [100, 200],        # Reduced from 3 to 2 options
    'xgbclassifier__max_depth': [3, 5],           # Reduced from 3 to 2 options
    'xgbclassifier__colsample_bytree': [0.8, 1.0],    # Reduced from 3 to 2 options
    'xgbclassifier__colsample_bylevel': [0.8, 1.0],   # Reduced from 3 to 2 options
    'xgbclassifier__learning_rate': [0.1, 0.2],       # Reduced from 3 to 2 options
    'xgbclassifier__reg_lambda': [1, 10],          # Reduced from 3 to 2 options
}
# Model pipeline
